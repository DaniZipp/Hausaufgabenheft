...
public class Object {
	...
	public void init() { // erstellen der Methode init()
		...
		next.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(pop, "Gewechselt zu n‰chste Woche.", "Information", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		last.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(pop, "Gewechselt zu letzte Woche.", "Information", JOptionPane.INFORMATION_MESSAGE);
			}
		});
